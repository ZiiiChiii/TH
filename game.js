...
window.render = function() {
  ...
  // 【修正三】只有在非動畫回調期間，才把目前狀態存進 lastPlayerState 供下次比較
  if (!isAnimating) {
  ...
  // 【修正一】在 window.render 最尾端，確保每次更新完 DOM 均觸發 Idle 動畫重建套用
